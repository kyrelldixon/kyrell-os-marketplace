...
**Test these:**
- Observable outcomes (return values, side effects, state changes)
- Utility functions and pure logic
- Type correctness: `bunx tsc --noEmit`
- Structural contracts (API shapes, required fields)

**Skip these:**
- What TypeScript already guarantees (type narrowing, interface compliance)
- Internal step names or call order
- Mock invocation counts
- Source code string matching
- Functions needing 5+ mocked systems (redesign instead)
